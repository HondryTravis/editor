...
UnitTest.test('browser.tinymce.themes.modern.test.ui.MenubarTest', function () {
    ...
    testMenubar('Default config should match', [
        {
            text: 'File',
            menu: [
    ...
    testMenubar('Default config with some removed items', [
        {
            text: 'File',
            menu: [
                menuItem('newdocument'),
    ...
    testMenubar('Menubar config with only file menu button', [
        {
            text: 'File',
            menu: [
                menuItem('newdocument'),
    ...
    testMenubar('Menu custom config', [
        {
            text: 'Custom file',
            menu: [
                menuItem('newdocument'),
    ...
    testMenubar('Menu custom config cleanup separators', [
        {
            text: 'Custom file',
            menu: [
                menuItem('newdocument'),
    ...
    testMenubarCustomItems('Adding custom menu items by context', [
        {
            text: 'File',
            menu: [
                menuCustomItem({
    ...
    testMenubarCustomItems('Adding custom menu items', [
        {
            text: 'File',
            menu: [
                menuCustomItem({
...
//# sourceMappingURL=MenubarTest.js.map