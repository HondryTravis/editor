...
export default function () {
    ...
    var sWaitForEditorLoaded = Waiter.sTryUntil('Waiting for iframe to load', Step.sync(function () {
    ...
    var component = GuiFactory.build(GuiFactory.external({
        element: frame
    }));
    return {
        ...
        sWaitForEditorLoaded: sWaitForEditorLoaded,
        sClear: delegate.sClear,
        sPrepareState: delegate.sPrepareState
    };
}
//# sourceMappingURL=TestFrameEditor.js.map