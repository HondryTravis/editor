...
UnitTest.asynctest('Browser Test: features.BasicFormattingTest', function () {
    ...
    TestTheme.setup({
    ...
    }, success, failure).use(function (realm, apis, toolbar, socket, buttons, onSuccess, onFailure) {
        ...
        var sTestFormatter = function (openTag, closeTag, name) {
            ...
            return GeneralSteps.sequence([
                apis.sSetContent('<p>no format <' + openTag + '>format</' + closeTag + '>'),
...
//# sourceMappingURL=BasicFormattingTest.js.map