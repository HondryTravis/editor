...
UnitTest.asynctest('Browser Test: ui.SerialisedLinkTest', function () {
    ...
    var sAssertNavigation = function (label, prevEnabled, nextEnabled) {
        return Logger.t(label, Step.sync(function () {
            ...
            var assertNavButton = function (buttonLabel, expected, button) {
                Assertions.assertStructure('Checking ' + buttonLabel + ' button should be enabled = ' + expected, ApproxStructure.build(function (s, str, arr) {
    ...
    var sTestScenario = function (rawScenario) {
        ...
        return Logger.t(scenario.label, GeneralSteps.sequence([
...
//# sourceMappingURL=SerialisedLinkTest.js.map