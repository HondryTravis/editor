...
UnitTest.asynctest('Browser Test: ios.IosRealmTest', function () {
    ...
    var onload = DomEvent.bind(iframe, 'load', function () {
        ...
        Replacing.append(realm.system().getByDom(Element.fromDom(realm.element().dom().querySelector('.tinymce-mobile-editor-socket'))).getOrDie(), GuiFactory.external({
            element: editor
        }));
        realm.init({
            editor: {
    ...
    var mShowKeyboard = function (selector, index) {
        ...
        return Step.stateful(function (value, next, die) {
            ...
            var newValue = Merger.deepMerge(value, {
                target: target,
                cursorY: cursorY
            });
            // tslint:disable-next-line:no-console
...
//# sourceMappingURL=IosRealmTest.js.map