...
var getRawOrComputed = function (isRoot, rawStart) {
    ...
    return optStart.map(function (start) {
        var inline = PredicateFind.closest(start, function (elem) { return Css.getRaw(elem, 'font-size').isSome(); }, isRoot)
            .bind(function (elem) { return Css.getRaw(elem, 'font-size'); });
