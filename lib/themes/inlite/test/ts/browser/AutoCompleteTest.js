import { Chain, FocusTools, GeneralSteps, Keyboard, Keys, Pipeline, UiControls, UiFinder } from '@ephox/agar';
...
UnitTest.asynctest('browser.AutoCompleteTest', function () {
    ...
    var sSetupLinkableContent = function (tinyApis) {
        return GeneralSteps.sequence([
            tinyApis.sSetContent('<h1 id="a">abc</h1>' +
                '<h2 id="b">abcd</h2>' +
                '<h3 id="c">abce</h3>'),
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            tinyApis.sAssertContent('<h1 id="a"><a href="#b">a</a>bc</h1>\n' +
                '<h2 id="b">abcd</h2>\n' +
                '<h3 id="c">abce</h3>')
        ], onSuccess, onFailure);
    }, {
...
//# sourceMappingURL=AutoCompleteTest.js.map