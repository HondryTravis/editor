...
UnitTest.asynctest('browser.tinymce.plugins.textpattern.TextPatternPluginTest', function (success, failure) {
    TextpatternPlugin();
    Theme();
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        var steps = Utils.withTeardown([
            ...
            Logger.t('getPatterns/setPatterns', Step.sync(function () {
                ...
                Assertions.assertEq('should be the same', editor.plugins.textpattern.getPatterns(), [
                    {
                        format: 'h3',
                        start: '###'
                    },
...
//# sourceMappingURL=TextPatternPluginTest.js.map