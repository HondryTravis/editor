...
UnitTest.asynctest('Browser Test: .FormatterTest', function () {
    ...
    var inlinePatterns = Settings.getPatternSet({}).inlinePatterns;
    ...
    var cGetInlinePattern = function (patterns, space) {
        return Chain.mapper(function (input) {
            var x = findInlinePattern(patterns, input, space);
    ...
    Pipeline.async({}, [
        ...
        Logger.t('run on range that is not on a text node without pattern returns undefined', Chain.asStep(createParagraphElementRng('text', 1, 1), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is undefined', 'undefined')
        ])),
        ...
        Logger.t('inline * without content before or after', Chain.asStep(createRng('*x*', 3, 3), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '*', end: '*', format: 'italic' }, startOffset: 0, endOffset: 2 })
        ])),
        Logger.t('inline * with content before', Chain.asStep(createRng('a *x*', 5, 5), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '*', end: '*', format: 'italic' }, startOffset: 2, endOffset: 4 })
        ])),
        ...
        Logger.t('inline ** without content before or after', Chain.asStep(createRng('**x**', 5, 5), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '**', end: '**', format: 'bold' }, startOffset: 0, endOffset: 3 })
        ])),
        Logger.t('inline ** with content before', Chain.asStep(createRng('a **x**', 7, 7), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '**', end: '**', format: 'bold' }, startOffset: 2, endOffset: 5 })
        ])),
        ...
        Logger.t('inline *** without content before or after', Chain.asStep(createRng('***x***', 7, 7), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '***', end: '***', format: ['bold', 'italic'] }, startOffset: 0, endOffset: 4 })
        ])),
        Logger.t('inline *** with content before', Chain.asStep(createRng('a ***x***', 9, 9), [
            cGetInlinePattern(inlinePatterns, false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '***', end: '***', format: ['bold', 'italic'] }, startOffset: 2, endOffset: 6 })
        ])),
        ...
        Logger.t('force only ** pattern and test return on not existing *** pattern', Chain.asStep(createRng('***x***', 7, 7), [
            ...
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '**', end: '**', format: 'bold' }, startOffset: 1, endOffset: 4 })
        ])),
        Logger.t('force only ** pattern and test return on not existing *** pattern', Chain.asStep(createRng('y ***x***', 9, 9), [
            cGetInlinePattern([{ start: '**', end: '**', format: 'bold' }], false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '**', end: '**', format: 'bold' }, startOffset: 3, endOffset: 6 })
        ])),
        Logger.t('force only ** pattern and test return on not existing *** pattern', Chain.asStep(createRng('y ***x*** **', 9, 9), [
            cGetInlinePattern([{ start: '**', end: '**', format: 'bold' }], false),
            Assertions.cAssertEq('is correct pattern and offset', { pattern: { start: '**', end: '**', format: 'bold' }, startOffset: 3, endOffset: 6 })
...
//# sourceMappingURL=FindInlinePatternTest.js.map