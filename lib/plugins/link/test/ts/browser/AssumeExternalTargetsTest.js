...
UnitTest.asynctest('browser.tinymce.plugins.link.AssumeExternalTargetsTest', function () {
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            tinyUi.sWaitForUi('wait for dialog', 'span:contains("The URL you entered seems to be an external link. Do you want to add the required http:// prefix?")'),
            tinyUi.sClickOnUi('click ok button', 'button > span:contains("Ok")'),
...
//# sourceMappingURL=AssumeExternalTargetsTest.js.map