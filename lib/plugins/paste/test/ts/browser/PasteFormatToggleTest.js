...
UnitTest.asynctest('tinymce.plugins.paste.browser.PasteFormatToggleTest', function (success, failure) {
    ModernTheme();
    PastePlugin();
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        var tinyApis = TinyApis(editor);
        var steps = Env.webkit ? [
            Logger.t('paste plain text', GeneralSteps.sequence([
...
//# sourceMappingURL=PasteFormatToggleTest.js.map