...
UnitTest.asynctest('browser.core.SubmitTest', function () {
    ...
    var sTestPlaceholder = function (ui, editor, apis, url, expected, struct) {
        return GeneralSteps.sequence([
            ...
            Waiter.sTryUntil('Wait for structure check', apis.sAssertContentStructure(struct), 100, 3000),
            apis.sSetContent('')
        ]);
    };
    var sTestScriptPlaceholder = function (ui, editor, apis, expected, struct) {
        return GeneralSteps.sequence([
            apis.sSetContent('<script src="http://media1.tinymce.com/123456"></script>' +
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            sTestScriptPlaceholder(ui, editor, apis, '<p>\n' +
                ...
                '</p>', scriptStruct),
            sTestPlaceholder(ui, editor, apis, 'https://www.youtube.com/watch?v=P_205ZY52pY', '<p><iframe src="//www.youtube.com/embed/P_205ZY52pY" width="560" ' +
                'height="314" allowfullscreen="allowfullscreen"></iframe></p>', placeholderStructure),
            Utils.sSetSetting(editor.settings, 'media_live_embeds', true),
            sTestPlaceholder(ui, editor, apis, 'https://www.youtube.com/watch?v=P_205ZY52pY', '<p><iframe src="//www.youtube.com/embed/P_205ZY52pY" width="560" ' +
                'height="314" allowfullscreen="allowfullscreen"></iframe></p>', iframeStructure)
        ], onSuccess, onFailure);
    }, {
        plugins: ['media'],
        toolbar: 'media',
...
//# sourceMappingURL=PlaceholderTest.js.map