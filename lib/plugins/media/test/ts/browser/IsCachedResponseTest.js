import { Assertions, Chain, GeneralSteps, Guard, Logger, Mouse, Pipeline, UiControls, UiFinder } from '@ephox/agar';
...
UnitTest.asynctest('browser.tinymce.plugins.media.IsCachedResponseTest', function () {
    ...
    var cAssertEmbedValue = function (expected) {
        return Chain.control(Chain.fromChains([
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            Logger.t('test cached response', GeneralSteps.sequence([
                ...
                Chain.asStep({}, [
                    Chain.fromParent(tinyUi.cWaitForPopup('wait for media dialog', 'div[role="dialog"]'), [
                        Chain.fromChains([
...
//# sourceMappingURL=IsCachedResponseTest.js.map