...
UnitTest.asynctest('browser.tinymce.plugins.media.DimensionsControlTest', function () {
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            Waiter.sTryUntil('Wait for dialog to close', UiFinder.sNotExists(TinyDom.fromDom(document.body), 'div[aria-label="Insert/edit media"][role="dialog"]'), 50, 5000)
        ], onSuccess, onFailure);
    }, {
        plugins: ['media'],
        toolbar: 'media',
...
//# sourceMappingURL=DimensionsControlTest.js.map