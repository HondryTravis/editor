import { ApproxStructure, Assertions, Chain, GeneralSteps, Logger, Mouse, Pipeline, Step, UiControls, UiFinder } from '@ephox/agar';
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        var sAssertElementStructure = function (selector, expected) {
            return Step.sync(function () {
                ...
                Assertions.assertStructure('Asserting HTML structure of the element: ' + selector, ApproxStructure.fromHtml(expected), SelectorFind.descendant(Element.fromDom(body), selector).getOrDie('Nothing in the Editor matches selector: ' + selector));
            });
        };
        ...
        Pipeline.async({}, [
            ...
            Logger.t('Table properties dialog (get data from full table)', GeneralSteps.sequence([
                api.sSetContent('<table style="width: 100px; height: 101px;" border="4" cellspacing="2" cellpadding="3">' +
                    '<caption>&nbsp;</caption>' +
                    '<tbody>' +
                    '<tr>' +
                    '<td>&nbsp;</td>' +
            ...
            Logger.t('Table properties dialog (change: border,cellpadding,cellspacing,align,backgroundColor,borderColor)', GeneralSteps.sequence([
                ...
                sAssertElementStructure('table', '<table style="float: right; border-color: red; background-color: blue;" border="1" cellspacing="3" cellpadding="2">' +
            ...
            Logger.t('Table properties dialog css border', GeneralSteps.sequence([
                ...
                sAssertElementStructure('table', '<table style=\"border-color: green; border-width: 1px;\" data-mce-border-color=\"green\" data-mce-border=\"1\">' +
...
//# sourceMappingURL=TableDialogTest.js.map