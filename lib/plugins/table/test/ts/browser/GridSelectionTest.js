...
UnitTest.asynctest('browser.tinymce.plugins.table.GridSelectionTest', function () {
    ...
    suite.test('Table grid selection', function (editor) {
        ...
        assertTableSelection(editor, '<table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table>', ['1', '4'], ['1', '2', '3', '4']);
        assertTableSelection(editor, '<table><tr><td colspan="2" rowspan="2">1</td><td>3</td></tr><tr><td>6</td></tr></table>', ['1', '6'], ['1', '3', '6']);
        assertTableSelection(editor, '<table>' +
            '<tr>' +
            '<td>1</td>' +
            '<td>2</td>' +
            '<td>3</td>' +
...
//# sourceMappingURL=GridSelectionTest.js.map