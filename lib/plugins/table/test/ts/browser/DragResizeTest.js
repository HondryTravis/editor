import { Assertions, Chain, GeneralSteps, Logger, Mouse, Pipeline, Step, UiFinder, Waiter, RawAssertions } from '@ephox/agar';
...
UnitTest.asynctest('browser.tinymce.plugins.table.DragResizeTest', function () {
    ...
    var sAssertNoDataStyle = function (editor, path) { return Step.sync(function () {
        var element = Hierarchy.follow(Element.fromDom(editor.getBody()), path).getOrDie('could not find element');
        var hasDataStyle = Attr.has(element, 'data-mce-style');
    ...
    var sWaitForSelection = function (editor, tinyApis) {
        return GeneralSteps.sequence([
            ...
            Waiter.sTryUntil('wait for resize handles', UiFinder.sExists(Element.fromDom(editor.getBody()), '#mceResizeHandlese'), 10, 1000)
        ]);
    };
...
//# sourceMappingURL=DragResizeTest.js.map