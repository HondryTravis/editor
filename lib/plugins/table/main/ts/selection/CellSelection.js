...
import { Element, Selection, SelectionDirection, Class } from '@ephox/sugar';
...
export default function (editor, lazyResize) {
    ...
    editor.on('init', function (e) {
        ...
        var hasShiftKey = function (event) { return event.raw().shiftKey === true; };
        ...
        var isMouseEvent = function (event) { return event.hasOwnProperty('x') && event.hasOwnProperty('y'); };
