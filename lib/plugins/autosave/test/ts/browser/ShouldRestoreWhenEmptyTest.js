...
UnitTest.asynctest('browser.tinymce.plugins.autosave.ShouldRestoreWhenEmptyTest', function (success, failure) {
    Theme();
    Plugin();
    var cAssertHasDraft = function (expected) { return Chain.op(function (editor) {
        RawAssertions.assertEq("should" + (!expected ? 'n\'t' : '') + " have draft", expected, editor.plugins.autosave.hasDraft());
    }); };
    var cStoreDraft = Chain.op(function (editor) {
        editor.plugins.autosave.storeDraft();
    });
    var cRemoveDraft = Chain.op(function (editor) {
        editor.plugins.autosave.removeDraft();
    });
    var cAddUndoLevel = Chain.op(function (editor) {
        editor.undoManager.add();
    });
    var testingPrefix = Math.random().toString(36).substring(7);
    Pipeline.async({}, [
...
//# sourceMappingURL=ShouldRestoreWhenEmptyTest.js.map