...
export default function (editor) {
    ...
    var cWaitForState = function (predicate) {
        return Chain.control(cHasState(predicate), Guard.tryUntil('Predicate has failed.', 10, 3000));
    };
    var cWaitForChain = function (chain) {
        return Chain.control(chain, Guard.tryUntil('Chain has failed.', 10, 3000));
    };
    var cFindChildWithState = function (selector, predicate) {
        return Chain.async(function (scope, next, die) {
