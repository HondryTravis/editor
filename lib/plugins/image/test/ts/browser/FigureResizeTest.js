...
UnitTest.asynctest('browser.tinymce.plugins.image.FigureResizeTest', function () {
    ...
    var cFillActiveDialog = function (json) { return Chain.op(function (editor) {
    ...
    Pipeline.async({}, [
        Chain.asStep({}, [
            ...
            NamedChain.asChain([
                ...
                NamedChain.direct('editorBody', Chain.control(UiFinder.cFindIn('#mceResizeHandlese'), Guard.tryUntil('wait for resize handlers', 100, 40000)), '_'),
...
//# sourceMappingURL=FigureResizeTest.js.map