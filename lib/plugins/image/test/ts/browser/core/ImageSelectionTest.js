...
UnitTest.asynctest('browser.tinymce.plugins.image.core.ImageSelectionTest', function (success, failure) {
    Theme();
    Plugin();
    var sUpdateImageOrFigure = function (editor, data) {
    ...
    var sWaitForDragHandles = function (editor) {
...
//# sourceMappingURL=ImageSelectionTest.js.map