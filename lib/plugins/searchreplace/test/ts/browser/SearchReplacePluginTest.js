...
UnitTest.asynctest('browser.tinymce.plugins.searchreplace.SearchReplacePluginTest', function () {
    ...
    suite.test('Find multiple matches with pre blocks', function (editor) {
        ...
        LegacyUnit.equal(HtmlUtils.normalizeHtml(editor.getBody().innerHTML), ('a<span class="mce-match-marker mce-match-marker-selected" data-mce-bogus="1" data-mce-index="0">b</span>c' +
...
//# sourceMappingURL=SearchReplacePluginTest.js.map