        ...
        self.on('postrender show', function (e) {
            if (e.control === self) {
                ...
                if (self.modal && !hasModal) {
                    $modalBlockEl_1 = DomQuery('#' + prefix_1 + 'modal-block', self.getContainerElm());
                    if (!$modalBlockEl_1[0]) {
                        $modalBlockEl_1 = DomQuery('<div id="' + prefix_1 + 'modal-block" class="' + prefix_1 + 'reset ' + prefix_1 + 'fade"></div>').appendTo(self.getContainerElm());
                    }
                    Delay.setTimeout(function () {
                        $modalBlockEl_1.addClass(prefix_1 + 'in');
                        DomQuery(self.getEl()).addClass(prefix_1 + 'in');
                    });
                    hasModal = true;
                }
                addRemove(true, self);
...
//# sourceMappingURL=FloatPanel.js.map