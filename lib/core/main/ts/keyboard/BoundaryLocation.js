...
var getElement = function (location) {
    return location.fold(Fun.identity, // Before
    Fun.identity, // Start
    Fun.identity, // End
    Fun.identity // After
    );
...
var getName = function (location) {
    return location.fold(Fun.constant('before'), // Before
...
var outside = function (location) {
    return location.fold(Location.before, // Before
...
var inside = function (location) {
    return location.fold(Location.start, // Before
...
var skipNoMovement = function (fromLocation, toLocation) {
    return fromLocation.fold(Fun.constant(true), function (fromLocation) {
...
var findLocationSimple = function (forward, location) {
    if (forward) {
        return location.fold(Fun.compose(Option.some, Location.start), // Before -> Start
        Option.none, Fun.compose(Option.some, Location.after), // End -> After
        Option.none);
    }
    else {
        return location.fold(Option.none, Fun.compose(Option.some, Location.before), // Before <- Start
        Option.none, Fun.compose(Option.some, Location.end) // End <- After
        );
    }
};
...
//# sourceMappingURL=BoundaryLocation.js.map