...
var SelectionOverrides = function (editor) {
    ...
    var fakeCaret = FakeCaret(editor.getBody(), isBlock, function () { return EditorFocus.hasFocus(editor); });
    ...
    var registerEvents = function () {
        ...
        editor.on('ResizeWindow FullscreenStateChanged', function () { return fakeCaret.reposition(); });
    ...
    var addCss = function () {
        ...
        styles.push(rootClass + ' .mce-offscreen-selection {' +
            'position: absolute;' +
            'left: -9999999999px;' +
            'max-width: 1000000px;' +
            '}' +
    ...
    var setContentEditableSelection = function (range, forward) {
        ...
        $realSelectionContainer = SelectorFind.descendant(SugarElement.fromDom(editor.getBody()), '#' + realSelectionId).fold(function () {
            return $([]);
        }, function (elm) {
            return $([elm.dom()]);
        });
...
//# sourceMappingURL=SelectionOverrides.js.map