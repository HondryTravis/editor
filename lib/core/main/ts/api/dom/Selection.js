 ...
 */
export var Selection = function (dom, win, serializer, editor) {
     ...
     */
    var getContent = function (args) { return GetSelectionContent.getContent(editor, args); };
    /**
     ...
     */
    var setContent = function (content, args) { return SetSelectionContent.setContent(editor, content, args); };
    /**
     ...
     */
    var getStart = function (real) { return ElementSelection.getStart(editor.getBody(), getRng(), real); };
    /**
     ...
     */
    var getEnd = function (real) { return ElementSelection.getEnd(editor.getBody(), getRng(), real); };
    /**
     ...
     */
    var getBookmark = function (type, normalized) { return bookmarkManager.getBookmark(type, normalized); };
    /**
     ...
     * tinymce.activeEditor.selection.moveToBookmark(bm);
     */
    var moveToBookmark = function (bookmark) { return bookmarkManager.moveToBookmark(bookmark); };
    /**
     ...
     */
    var getSel = function () { return win.getSelection ? win.getSelection() : win.document.selection; };
    /**
    ...
    var getRng = function () {
        ...
        if (editor.bookmark !== undefined && EditorFocus.hasFocus(editor) === false) {
            ...
            if (bookmark.isSome()) {
                return bookmark.map(function (r) { return EventProcessRanges.processRanges(editor, [r])[0]; }).getOr(doc.createRange());
            }
        }
        try {
            if ((selection = getSel())) {
     ...
     * alert(tinymce.activeEditor.selection.getNode().nodeName);
     */
    var getNode = function () { return ElementSelection.getNode(editor.getBody(), getRng()); };
    var getSelectedBlocks = function (startElm, endElm) { return ElementSelection.getSelectedBlocks(dom, getRng(), startElm, endElm); };
    ...
    var scrollIntoView = function (elm, alignToTop) { return ScrollIntoView.scrollElementIntoView(editor, elm, alignToTop); };
    var placeCaretAt = function (clientX, clientY) { return setRng(CaretRangeFromPoint.fromPoint(clientX, clientY, editor.getDoc())); };
