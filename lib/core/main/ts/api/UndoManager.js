...
export default function (editor) {
    ...
    var isInsertReplacementText = function (event) { return event.inputType === 'insertReplacementText'; };
    // Safari just shows inputType `insertText` but with data set to null so we can use that
    var isInsertTextDataNull = function (event) { return event.inputType === 'insertText' && event.data === null; };
