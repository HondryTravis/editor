...
var isTreeNode = function (content) { return content instanceof Node; };
...
var setContent = function (editor, content, args) {
    ...
    return Option.from(editor.getBody()).fold(Fun.constant(content), function (body) { return isTreeNode(content) ? setContentTree(editor, body, content, args) : setContentString(editor, body, content, args); });
};
export { setContent };
