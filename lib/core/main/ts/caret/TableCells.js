...
var getCorners = function (getYAxisValue, tds) {
    return Arr.bind(tds, function (td) {
        var rect = deflate(roundRect(td.getBoundingClientRect()), -1);
        return [
...
var getClosestCell = function (getYAxisValue, isTargetCorner, table, x, y) {
    var cells = SelectorFilter.descendants(Element.fromDom(table), 'td,th,caption').map(function (e) { return e.dom(); });
