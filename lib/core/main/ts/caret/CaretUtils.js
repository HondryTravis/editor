...
var before = Fun.curry(beforeAfter, true);
var after = Fun.curry(beforeAfter, false);
var normalizeRange = function (direction, root, range) {
    var node, container, offset, location;
    var leanLeft = Fun.curry(lean, true, root);
    var leanRight = Fun.curry(lean, false, root);
...
var isBeforeContentEditableFalse = Fun.curry(isNextToContentEditableFalse, 0);
var isAfterContentEditableFalse = Fun.curry(isNextToContentEditableFalse, -1);
var isBeforeTable = Fun.curry(isNextToTable, 0);
var isAfterTable = Fun.curry(isNextToTable, -1);
...
var isBeforeSpace = Fun.curry(isChar, true, isWhiteSpace);
var isAfterSpace = Fun.curry(isChar, false, isWhiteSpace);
var getElementFromPosition = function (pos) { return Option.from(pos.getNode()).map(Element.fromDom); };
var getElementFromPrevPosition = function (pos) { return Option.from(pos.getNode(true)).map(Element.fromDom); };
