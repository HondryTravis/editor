 ...
 */
var isContentEditableFalse = NodeType.isContentEditableFalse, isContentEditableTrue = NodeType.isContentEditableTrue;
...
var start = function (state, editor) {
    return function (e) {
        if (isLeftMouseButtonPressed(e)) {
            var ceElm = Arr.find(editor.dom.getParents(e.target), Predicate.or(isContentEditableFalse, isContentEditableTrue)).getOr(null);
...
//# sourceMappingURL=DragDropOverrides.js.map