...
var normalizeSelection = function (editor, rng) {
    ...
    }).fold(function () { editor.selection.normalize(); return; }, function (caretPos) { return editor.selection.setRng(caretPos.toRange()); });
};
...
var hasFocus = function (editor) { return editor.inline ? hasInlineFocus(editor) : hasIframeFocus(editor); };
...
var activateEditor = function (editor) { return editor.editorManager.setActive(editor); };
