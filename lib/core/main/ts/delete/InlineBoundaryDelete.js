...
var backspaceDeleteCollapsed = function (editor, caret, forward, from) {
    ...
    return fromLocation.bind(function (location) {
        if (forward) {
            return location.fold(Fun.constant(Option.some(BoundaryLocation.inside(location))), // Before
            Option.none, // Start
            ...
            return location.fold(Option.none, // Before
...
//# sourceMappingURL=InlineBoundaryDelete.js.map