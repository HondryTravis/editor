...
UnitTest.asynctest('atomic.tinymce.core.keyboard.MatchKeysTest', function () {
    ...
    Pipeline.async({}, [
        ...
        sTestExecute([
            { keyCode: 65, ctrlKey: true, metaKey: true, altKey: true, action: actionA },
            { keyCode: 65, ctrlKey: true, metaKey: true, action: actionB }
        ], event({ keyCode: 65, metaKey: true, ctrlKey: true }), ['b'], { shiftKey: false, altKey: false, ctrlKey: true, metaKey: true, keyCode: 65, action: actionB }),
...
//# sourceMappingURL=MatchKeysTest.js.map