...
UnitTest.asynctest('browser.tinymce.core.CaretWalkerTest', function (success, failure) {
    ...
    var getChildNode = function (childIndex) {
    ...
    suite.test('over script/style/textarea', function () {
        ...
        CaretAsserts.assertCaretPosition(logicalCaret.next(CaretPosition(getRoot().firstChild, 1)), CaretPosition(getRoot().childNodes[2], 0));
        CaretAsserts.assertCaretPosition(logicalCaret.next(CaretPosition(getRoot().childNodes[2], 1)), CaretPosition(getRoot().childNodes[4], 0));
        ...
        CaretAsserts.assertCaretPosition(logicalCaret.prev(CaretPosition(getRoot().childNodes[4], 0)), CaretPosition(getRoot().childNodes[2], 1));
...
//# sourceMappingURL=CaretWalkerTest.js.map