...
UnitTest.asynctest('browser.tinymce.core.CaretCandidateTest', function () {
    ...
    suite.test('isAtomic', function () {
        ...
        LegacyUnit.equal(CaretCandidate.isAtomic($('<span contentEditable="false">X<span contentEditable="true">Y</span>Z</span>')[0]), false);
    });
...
//# sourceMappingURL=CaretCandidateTest.js.map