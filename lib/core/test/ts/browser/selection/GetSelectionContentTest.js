...
UnitTest.asynctest('browser.tinymce.selection.GetSelectionContentTest', function (success, failure) {
    Theme();
    var testDivId = 'testDiv1';
    var sFocusDiv = Step.sync(function () {
    ...
    var sAssertGetContent = function (label, editor, expectedContents, args) {
        if (args === void 0) { args = {}; }
    ...
    var sAssertGetContentOverrideBeforeGetContent = function (label, editor, expectedContents, args) {
        if (args === void 0) { args = {}; }
...
//# sourceMappingURL=GetSelectionContentTest.js.map