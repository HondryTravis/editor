...
UnitTest.asynctest('browser.tinymce.core.FormatterApplyTest', function () {
    ...
    suite.test('apply inline to a list', function (editor) {
        ...
        LegacyUnit.equal(getContent(editor), '<p><b>1234</b></p><ul><li><b>first element</b></li><li><b>second element</b></li></ul><p><b>5678</b></p>', 'selection of a list');
    });
    ...
    suite.test('Inline element on multiple selected elements with various childnodes', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><b><em>1234</em>5678<span>9</span></b></p><p><b><em>1234</em>5678<span>9</span></b></p>', 'Inline element on multiple selected elements with various childnodes');
    });
    ...
    suite.test('Inline element with attributes and styles', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><b id="value2" style="color: #ff0000; font-size: 10px;" title="value1">1234</b></p>', 'Inline element with attributes and styles');
    });
    ...
    suite.test('Inline element with redundant parents of similar types', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="font-weight: bold;"><strong><b>a<em>1234</em>b</b></strong></span></p>', 'Inline element with redundant parents of similar types');
    });
    ...
    suite.test('Inline element merged with child 2', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style=\"font-weight: bold;\">a<span style=\"color: #ff0000;\">1234</span>b</span></p>', 'Inline element merged with child 2');
    });
    suite.test('Inline element merged with child 3', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style=\"font-weight: bold;\">a<span id=\"id\">1234</span>b</span></p>', 'Inline element merged with child 3');
    });
    suite.test('Inline element merged with child 3', function (editor) {
        editor.formatter.register('format', {
            inline: 'span',
    ...
    suite.test('Inline element not merged in exact mode', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="color: #00ff00;"><span style="color: #ff0000;">1234</span></span></p>', 'Inline element not merged in exact mode');
    });
    ...
    suite.test('Deep left branch', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><em><i><ins>1<b>234</b></ins></i></em><b><em>text1</em><em>text2</em></b></p><p><b><em>5678</em></b></p><p><b>9012</b></p>', 'Deep left branch');
    });
    suite.test('Deep right branch', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><b>9012</b></p><p><b><em>5678</em></b></p><p><b><em><i><ins>1234</ins></i></em><em>text1</em></b><em><b>text</b>2</em></p>', 'Deep right branch');
    });
    suite.test('Full element text selection on two elements with a table in the middle', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><b>1234</b></p><table><tbody><tr><td><b>123</b></td></tr></tbody></table><p><b>5678</b></p>', 'Full element text selection on two elements with a table in the middle');
    });
    ...
    suite.test('Apply format on single element that matches a selector 1', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p class="a b c" style="color: #ff0000;" title="test">1234</p>', 'Apply format on single element that matches a selector');
    });
    suite.test('Apply format on single element parent that matches a selector 2', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<div class="a b c" style="color: #ff0000;" title="test"><p>1234</p><p>test</p><p>1234</p></div>', 'Apply format on single element parent that matches a selector');
    });
    suite.test('Apply format on multiple elements that matches a selector 2', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p class="a b c" style="color: #ff0000;" title="test">1234</p><div>test</div><p class="a b c" style="color: #ff0000;" title="test">1234</p>', 'Apply format on multiple elements that matches a selector');
    });
    suite.test('Apply format on top of existing selector element', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p class="c d a b" style="color: #00ff00;" title="test2">1234</p>', 'Apply format on top of existing selector element');
    });
    suite.test('Format on single li that matches a selector', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<div><span class="a b c" style="color: #ff0000;" title="test">text</span></div>', 'Apply format on single element that matches a selector');
    });
    suite.test('Format on single div that matches a selector', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<div class="a b c" style="color: #ff0000;" title="test">text</div>', 'Apply format on single element that matches a selector');
    });
    suite.test('Bold and italics is applied to text that is not highlighted', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="font-family: Arial;"><strong>test1 <em>test2</em></strong> test3 test4 test5 test6</span></p>', 'Selected text should be bold.');
    });
    suite.test('Apply color format to links as well', function (editor) {
        ...
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="color: #ff0000;">123<a style="color: #ff0000;" href="#">abc</a>456</span></p>', 'Link should have it\'s own color.');
    });
    suite.test('Color on link element', function (editor) {
        ...
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="color: #ff0000; font-size: 10px;">123<a style="color: #ff0000;" href="#">abc</a>456</span></p>', 'Link should have it\'s own color.');
    });
    suite.test('Applying formats in lists', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(editor), '<ul><li><h1>text</h1><ul><li>nested</li></ul></li></ul>', 'heading should not automatically apply to sublists');
    });
    suite.test('Applying block format to first character in li', function (editor) {
        ...
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<ul><li><h1>ab</h1></li><li>cd</li></ul>', 'heading should be applied to first li');
    });
    suite.test('Applying block format to li wrapped in block', function (editor) {
        ...
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<div><ul><li><h1>ab</h1></li><li>cd</li></ul></div>', 'heading should be applied to first li only');
    });
    suite.test('Applying formats on a list including child nodes', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<ol><li><strong>a</strong></li><li><strong>b</strong><ul><li><strong>c</strong></li><li><strong>d</strong>' +
            '<br /><ol><li><strong>e</strong></li><li><strong>f</strong></li></ol></li></ul></li><li><strong>g</strong>' +
            '</li></ol>', 'should be applied to all sublists');
    });
    suite.test('Block format on li element', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<ul><li><h1>text</h1><ul><li><h1>nested</h1></li></ul></li></ul>', 'heading should automatically apply to sublists, when selection spans the sublist');
    });
    suite.test('Block on li element 2', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<ul><li>before<ul><li>nested</li></ul><h1>after</h1></li></ul>', 'heading should automatically apply to sublists, when selection spans the sublist');
    });
    suite.test('Block on li element 3', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<ul><li>before<ul><li><h1>nested</h1></li></ul><h1>after</h1></li></ul>', 'heading should automatically apply to sublists, when selection spans the sublist');
    });
    suite.test('Block on li element 4', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('h1');
        LegacyUnit.equal(editor.getContent(editor), '<ul><li><h1>before</h1><ul><li><h1>nested</h1></li></ul><h1>after</h1></li></ul>', 'heading should apply correctly when selection is after a sublist');
    });
    suite.test('Underline colors 1', function (editor) {
        ...
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="color: #ff0000; font-family: \'arial black\'; text-decoration: underline;">test</span></p>', 'Coloring an underlined text should result in a colored underline');
    });
    suite.test('Underline colors 2', function (editor) {
        ...
        editor.execCommand('SelectAll');
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="text-decoration: underline;"><span style="color: #ff0000; font-family: ' +
            '\'arial black\'; text-decoration: underline;">test</span></span></p>', 'Underlining colored text should result in a colored underline');
    });
    suite.test('Underline colors 3', function (editor) {
        ...
        editor.setContent('<p><span style="font-family: \'arial black\'; text-decoration: underline;"><em><strong>This is some ' +
            '<span style="color: rgb(255, 0, 0);">example</span></strong></em> text</span></p>');
        editor.execCommand('SelectAll');
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="text-decoration: underline;"><span style="font-family: \'arial black\';"><em>' +
    ...
    suite.test('Underline colors 4', function (editor) {
        ...
        editor.setContent('<p style="font-size: 22pt;"><span style=\"text-decoration: underline;\"><span style=\"color: yellow; ' +
        ...
        LegacyUnit.equal(getContent(editor), '<p style="font-size: 22pt;"><span style="text-decoration: underline;"><span style="color: yellow;' +
            ' text-decoration: underline;">yellow<span style="color: #ff0000; text-decoration: underline;">red</span>yellow</span></span></p>', 'Coloring an colored underdlined text should result in newly colored underline');
    });
    suite.test('Underline colors 5', function (editor) {
        ...
        editor.setContent('<p><span style="font-family: \'arial black\',\'avant garde\';"><em><strong>This is some <span style="color: ' +
        ...
        editor.selection.setRng(rng);
        editor.formatter.apply('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="text-decoration: underline;"><span style="font-family: \'arial black\',\'avant garde\';"' +
            ...
            ' #ff0000; text-decoration: underline;">example</span></strong></em> text</span></span></p>', 'Colored elements should be underlined when selection is across multiple paragraphs');
    });
    suite.test('Underline colors 6', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(editor), '<p><span style="text-decoration: underline;">This is some text.</span></p>', 'Children nodes that are underlined should be removed if their parent nodes are underlined');
    });
    suite.test('Underline colors 7', function (editor) {
        ...
        editor.setContent('<p><span style="text-decoration: underline;">This is <span style="color: #ff0000; text-decoration: underline; ' +
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(editor.getContent(editor), '<p><span style=\"text-decoration: underline;\">This is <span style=\"background-color: #ff0000;\">' +
            'some</span> text.</span></p>', 'Children nodes that are underlined should be removed if their parent nodes are underlined');
    });
    ...
    suite.test('Align nested table cell to same as parent', function (editor) {
        ...
        LegacyUnit.equal(getContent(editor), '<table>' +
            '<tbody>' +
            '<tr>' +
            '<td style="text-align: right;">a' +
            '<table>' +
    ...
    suite.test('All the nested childNodes having fontSize should receive backgroundColor as well', function (editor) {
        ...
        LegacyUnit.equal(getContent(editor), '<p><span style="background-color: #ff0000;">a <span style="font-size: 36pt; background-color: #ff0000;">b</span> c</span></p>');
    ...
    suite.test('Formatter should wrap elements that have data-mce-bogus attribute, rather then attempt to inject styles into it', function (editor) {
        ...
        editor.formatter.apply('fontname', { value: 'verdana' });
        LegacyUnit.equal(editor.getBody().innerHTML, '<p>That is a <span style="font-family: verdana;" data-mce-style="font-family: verdana;"><span class="mce-spellchecker-word" data-mce-bogus="1">misespelled</span></span> text</p>');
        ...
        LegacyUnit.equal(editor.getBody().innerHTML, '<p>That is a <span class="mce-spellchecker-word" data-mce-bogus="1">misespelled</span> text</p>');
    ...
    suite.test('Background color over range of font sizes', function (editor) {
        ...
        LegacyUnit.setSelection(editor, 'p', 0, 'span:nth-child(2)', 1);
        editor.formatter.apply('hilitecolor', { value: '#ff0000' });
        LegacyUnit.equal(getContent(editor), '<p><span style="background-color: #ff0000;">a<span style="font-size: 18px; background-color: #ff0000;">b</span><span style="font-size: 24px; background-color: #ff0000;">c</span></span></p>');
    });
    suite.test('TINY-865: Font size removed when changing background color', function (editor) {
        editor.getBody().innerHTML = ('<p><span style="background-color: #ffff00;"><span style="font-size: 8pt;">a</span> ' +
        ...
        editor.formatter.apply('hilitecolor', { value: '#ff0000' });
        LegacyUnit.equal(getContent(editor), '<p><span style="background-color: #ffff00;"><span style="font-size: 8pt;">a</span> <span ' +
    ...
    suite.test('Formatter should remove similar styles when clear_child_styles is set to true', function (editor) {
        editor.getBody().innerHTML = ('<p><span style="font-family: Arial; font-size: 13px">a</span>' +
        ...
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="font-size: 14px;"><span style="font-family: arial;">a</span><del style="font-family: arial;">b</del>c</span></p>');
    });
    ...
    suite.test('Formatter should remove similar styles when clear_child_styles isn\'t defined', function (editor) {
        ...
        editor.formatter.apply('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="font-size: 14px;"><span style="font-family: arial;">a</span><del style="font-size: 13px; font-family: arial;">b</del>c</span></p>');
    });
...
//# sourceMappingURL=FormatterApplyTest.js.map