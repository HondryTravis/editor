...
UnitTest.asynctest('browser.tinymce.core.keyboard.EnterKey', function () {
    ...
    suite.test('Enter at end of EM inside P', function (editor) {
        ...
        pressEnter(editor);
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(/<br([^>]+|)>|&nbsp;/g, ''), '<p><em>abc</em></p><p><em></em></p>');
    ...
    suite.test('Enter at beginning EM inside P', function (editor) {
        ...
        pressEnter(editor);
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(/<br([^>]+|)>|&nbsp;/g, ''), '<p><em></em></p><p><em>abc</em></p>');
    ...
    suite.test('Enter at end of STRONG in EM inside P', function (editor) {
        ...
        pressEnter(editor);
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(/<br([^>]+|)>|&nbsp;/g, ''), '<p><em><strong>abc</strong></em></p><p><em><strong></strong></em></p>');
    ...
    suite.test('Enter at beginning STRONG in EM inside P', function (editor) {
        ...
        pressEnter(editor);
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(/<br([^>]+|)>|&nbsp;/g, ''), '<p><em><strong></strong></em></p><p><em><strong>abc</strong></em></p>');
        LegacyUnit.equal(editor.selection.getRng(true).startContainer.nodeValue, 'abc');
    });
    ...
    suite.test('Enter inside empty TD', function (editor) {
        ...
        pressEnter(editor);
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(/<br([^>]+|)>|&nbsp;/g, ''), '<table><tbody><tr><td><p></p><p></p></td></tr></tbody></table>');
    ...
    suite.test('Shift+Enter inside STRONG inside TD with BR', function (editor) {
        ...
        LegacyUnit.equal(HtmlUtils.cleanHtml(editor.getBody().innerHTML), '<table><tbody><tr><td>d <strong>e<br></strong><br></td></tr></tbody></table>');
...
//# sourceMappingURL=EnterKeyTest.js.map