...
UnitTest.asynctest('browser.tinymce.core.keyboard.InsertKeysTest', function (success, failure) {
    Theme();
    var sFireInsert = function (editor) {
        return Step.sync(function () {
            editor.fire('input', { isComposing: false });
        });
    };
    var sFireKeyPress = function (editor) {
        return Step.sync(function () {
...
//# sourceMappingURL=InsertKeysTest.js.map