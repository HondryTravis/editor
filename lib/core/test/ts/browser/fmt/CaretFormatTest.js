...
UnitTest.asynctest('browser.tinymce.core.fmt.CaretFormatTest', function () {
    ...
    var sAssertNormalizedContentStructure = function (editor, expected) {
        return Step.sync(function () {
            ...
            rawBody.normalize();
            Assertions.assertStructure('Asserting the normalized structure of tiny content.', expected, Element.fromDom(rawBody));
        });
    };
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            Logger.t('replaceWithCaretFormat', Step.sync(function () {
                ...
                Assertions.assertStructure('Asserting the normalized structure of tiny content.', ApproxStructure.build(function (s, str) {
...
//# sourceMappingURL=CaretFormatTest.js.map