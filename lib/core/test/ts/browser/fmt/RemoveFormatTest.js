...
UnitTest.asynctest('browser.tinymce.core.fmt.RemoveFormatTest', function (success, failure) {
    ModernTheme();
    var sRemoveFormat = function (editor, format) {
...
//# sourceMappingURL=RemoveFormatTest.js.map