...
UnitTest.asynctest('browser.tinymce.core.html.StylesTest', function () {
    ...
    suite.test('Basic parsing/serializing', function () {
        ...
        LegacyUnit.equal(styles.serialize(styles.parse('background: url(\'http://www.site.com/(foo)\');')), 'background: url(\'http://www.site.com/(foo)\');');
    });
    suite.test('Colors force hex and lowercase', function () {
        ...
        LegacyUnit.equal(styles.serialize(styles.parse('  color:   RGB  (  1  ,  2  ,  3  )  ')), 'color: #010203;');
        LegacyUnit.equal(styles.serialize(styles.parse('   FONT-SIZE  :  10px  ;   COLOR  :  RGB  (  1  ,  2  ,  3  )   ')), 'font-size: 10px; color: #010203;');
        LegacyUnit.equal(styles.serialize(styles.parse('   FONT-SIZE  :  10px  ;   COLOR  :  RED   ')), 'font-size: 10px; color: red;');
    });
    suite.test('Urls convert urls and force format', function () {
        ...
        LegacyUnit.equal(styles.serialize(styles.parse('background: url(   "a"   )')), 'background: url(\'|a|\');');
        LegacyUnit.equal(styles.serialize(styles.parse('background: url(    \'a\'    )')), 'background: url(\'|a|\');');
        LegacyUnit.equal(styles.serialize(styles.parse('background1: url(a); background2: url("a"); background3: url(\'a\')')), 'background1: url(\'|a|\'); background2: url(\'|a|\'); background3: url(\'|a|\');');
        LegacyUnit.equal(styles.serialize(styles.parse('background: url(\'http://www.site.com/a?a=b&c=d\')')), 'background: url(\'|http://www.site.com/a?a=b&c=d|\');');
        LegacyUnit.equal(styles.serialize(styles.parse('background: url(\'http://www.site.com/a_190x144.jpg\');')), 'background: url(\'|http://www.site.com/a_190x144.jpg|\');');
    });
    suite.test('Compress styles', function () {
        var styles = Styles();
        LegacyUnit.equal(styles.serialize(styles.parse('border-top: 1px solid red; border-left: 1px solid red; border-bottom: 1px solid red; border-right: 1px solid red;')), 'border: 1px solid red;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-width: 1pt 1pt 1pt 1pt; border-style: none none none none; border-color: black black black black;')), 'border: 1pt none black;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-width: 1pt 4pt 2pt 3pt; border-style: solid dashed dotted none; border-color: black red green blue;')), 'border-width: 1pt 4pt 2pt 3pt; border-style: solid dashed dotted none; border-color: black red green blue;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-top: 1px solid red; border-left: 1px solid red; border-right: 1px solid red; border-bottom: 1px solid red')), 'border: 1px solid red;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-top: 1px solid red; border-right: 2px solid red; border-bottom: 3px solid red; border-left: 4px solid red')), 'border-top: 1px solid red; border-right: 2px solid red; border-bottom: 3px solid red; border-left: 4px solid red;');
        LegacyUnit.equal(styles.serialize(styles.parse('padding-top: 1px; padding-right: 2px; padding-bottom: 3px; padding-left: 4px')), 'padding: 1px 2px 3px 4px;');
        LegacyUnit.equal(styles.serialize(styles.parse('margin-top: 1px; margin-right: 2px; margin-bottom: 3px; margin-left: 4px')), 'margin: 1px 2px 3px 4px;');
        LegacyUnit.equal(styles.serialize(styles.parse('margin-top: 1px; margin-right: 1px; margin-bottom: 1px; margin-left: 2px')), 'margin: 1px 1px 1px 2px;');
        LegacyUnit.equal(styles.serialize(styles.parse('margin-top: 2px; margin-right: 1px; margin-bottom: 1px; margin-left: 1px')), 'margin: 2px 1px 1px 1px;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-top-color: red; border-right-color: green; border-bottom-color: blue; border-left-color: yellow')), 'border-color: red green blue yellow;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-width: 1px; border-style: solid; border-color: red')), 'border: 1px solid red;');
        LegacyUnit.equal(styles.serialize(styles.parse('border-width: 1px; border-color: red')), 'border-width: 1px; border-color: red;');
    });
    ...
    suite.test('Valid styles', function () {
        ...
        LegacyUnit.equal(styles.serialize(styles.parse('color: #ff0000; font-size: 10px; margin-left: 10px; invalid: 1;'), 'b'), 'color: #ff0000; font-size: 10px;');
        LegacyUnit.equal(styles.serialize(styles.parse('color: #ff0000; font-size: 10px; margin-left: 10px; invalid: 2;'), 'a'), 'color: #ff0000; font-size: 10px; margin-left: 10px;');
    });
    suite.test('Invalid styles', function () {
        ...
        LegacyUnit.equal(styles.serialize(styles.parse('color: #ff0000; font-size: 10px; margin-left: 10px; margin-right: 10px;'), 'a'), 'margin-right: 10px;');
    });
...
//# sourceMappingURL=StylesTest.js.map