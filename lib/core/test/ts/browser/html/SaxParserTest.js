...
UnitTest.asynctest('browser.tinymce.core.html.SaxParserTest', function () {
    ...
    suite.test('Parse elements', function () {
        ...
        writer.reset();
        parser.parse('<span id=id1 title="title value" class=\'class1 class2\' data-value="value1" ' +
            'MYATTR="val1" myns:myattr="val2" disabled empty=""></span>');
        LegacyUnit.equal(writer.getContent(), '<span id="id1" title="title value" class="class1 class2" data-value="value1" myattr="val1" ' +
            'myns:myattr="val2" disabled="disabled" empty=""></span>', 'Parse attribute formats.');
        ...
        LegacyUnit.equal(writer.getContent(), 'text1<span title="&lt;test" data-test="test&gt;"></span>', 'Parse element with </> in attributes.');
    ...
    suite.test('Parse style elements', function () {
        ...
        LegacyUnit.equal(writer.getContent(), 'text1<em><style id="id">// <b>tag</b></st' + 'yle>text2</em>', 'Parse style element with attributes.');
    ...
    suite.test('Parse script elements', function () {
        ...
        LegacyUnit.equal(writer.getContent(), 'text1<em><script id="id">// <b>tag</b></s' + 'cript>text2</em>', 'Parse script element with attributes.');
    ...
    suite.test('Parse doctype', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">text1', 'Parse DOCTYPE.');
    ...
    suite.test('Self closing', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<ul><li>1</li><li><b>2</b></li><li><em><b>3</b></em></li></ul>', 'Parse list with self closing items.');
    });
    suite.test('Preserve internal elements', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<b>text</b><span id="id" data-mce-type="something"></span>', 'Preserve internal span element without any span schema rule.');
        ...
        LegacyUnit.equal(writer.getContent(), '<span class="class"><b>text</b></span><span id="id" data-mce-type="something"></span>', 'Preserve internal span element with a span schema rule.');
    });
    suite.test('Remove internal elements', function () {
        ...
        writer.reset();
        parser.parse('<span id="id" class="class"><b>text</b></span><span id="id" data-mce-type="something"></span>');
        LegacyUnit.equal(writer.getContent(), '<span class="class"><b>text</b></span>', 'Remove internal span element with a span schema rule.');
        // Reset
    ...
    suite.test('Parse script urls (allowed)', function () {
        ...
        parser = SaxParser(counter, schema);
        writer.reset();
        parser.parse('<a href="javascript:alert(1)">1</a>' +
            '<a href=" 2 ">2</a>' +
            '<a href="data:text/html;base64,PHN2Zy9vbmxvYWQ9YWxlcnQoMik+">3</a>');
        LegacyUnit.equal(writer.getContent(), '<a href="javascript:alert(1)">1</a><a href=" 2 ">2</a>' +
            '<a href="data:text/html;base64,PHN2Zy9vbmxvYWQ9YWxlcnQoMik+">3</a>');
    });
    suite.test('Parse script urls (allowed html data uris)', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<a>1</a>' +
            '<a href="data:text/html;base64,PHN2Zy9vbmxvYWQ9YWxlcnQoMik+">2</a>' +
            '<a href="data:image/svg+xml;base64,x">3</a>');
    });
    suite.test('Parse script urls (disallow svg data image uris)', function () {
        ...
        parser = SaxParser(counter, schema);
        writer.reset();
        parser.parse('<a href="data:image/svg+xml;base64,x">1</a>');
        LegacyUnit.equal(writer.getContent(), '<a>1</a>');
    });
    suite.test('Parse script urls (denied)', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<a>1</a><a>2</a><a>3</a><a>4</a><a>5</a><a>6</a><a>7</a><a>8</a><a>9</a>' +
    ...
    suite.test('parse XSS PI', function () {
        ...
        LegacyUnit.equal(writer.getContent(), '<?xml &gt;&lt;iframe SRC=&amp;#106&amp;#97&amp;#118&amp;#97&amp;#115&amp;#99&amp;#114&amp;#105&amp;#112&amp;' +
    ...
    suite.test('Parse malformed elements without an end', function () {
        ...
        LegacyUnit.equal(writer.getContent(), 'a a&lt;b c');
    });
    Pipeline.async({}, suite.toSteps({}), function () {
        success();
    }, failure);
});
//# sourceMappingURL=SaxParserTest.js.map