...
UnitTest.asynctest('browser.tinymce.core.UndoManager', function () {
    ...
    suite.test('Exclude internal elements', function (editor) {
        ...
        editor.getBody().innerHTML = ('test' +
            '<img src="about:blank" data-mce-selected="1" />' +
            '<table data-mce-selected="1"><tr><td>x</td></tr></table>');
        editor.undoManager.add();
        LegacyUnit.equal(count, 1);
        LegacyUnit.equal(HtmlUtils.cleanHtml(lastLevel.content), 'test' +
            '<img src="about:blank">' +
            '<table><tbody><tr><td>x</td></tr></tbody></table>');
        editor.getBody().innerHTML = ('<span data-mce-bogus="1">x</span>' +
        ...
        LegacyUnit.equal(HtmlUtils.cleanHtml(lastLevel.content), '<span data-mce-bogus="1">x</span>' +
            '<span data-mce-bogus="1"></span>' +
            '<br data-mce-bogus="1">' +
            'test' +
            '\u200B' +
...
//# sourceMappingURL=UndoManagerTest.js.map