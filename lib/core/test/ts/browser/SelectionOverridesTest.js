...
UnitTest.asynctest('browser.tinymce.core.SelectionOverridesTest', function () {
    ...
    suite.test('click next to cE=false block', function (editor) {
        editor.setContent('<table style="width: 100%">' +
            '<tr>' +
    ...
    suite.test('offscreen copy of cE=false block remains offscreen', function (editor) {
        if (Env.ie || Env.gecko) {
            ...
            ok(offscreenSelection.offsetWidth + offscreenSelection.offsetLeft < 0, 'The cE=false offscreen selection is visible on-screen. Right edge: ' +
...
//# sourceMappingURL=SelectionOverridesTest.js.map