...
UnitTest.asynctest('browser.tinymce.core.FormattingCommandsTest', function () {
    ...
    suite.test('Justify - multiple block elements selected - queryCommandState', function (editor) {
        editor.setContent('<div style="text-align: left;"><div id="a" style="text-align: right;">' +
    ...
    suite.test('Formatting commands (xhtmlTextStyles)', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<p><span style="color: #ff0000; background-color: #ff0000;">test</span><span style="font-family: Arial;">test</span></p>');
    ...
    suite.test('Formatting commands (alignInline)', function (editor) {
        ...
        editor.selection.select(editor.dom.select('img')[0]);
        editor.execCommand('JustifyCenter');
        LegacyUnit.equal(editor.getContent(), '<p><img style="margin-right: auto; margin-left: auto; display: block;" src="tinymce/ui/img/raster.gif" /></p>');
        editor.setContent('<img src="tinymce/ui/img/raster.gif" />');
        editor.selection.select(editor.dom.select('img')[0]);
        editor.execCommand('JustifyRight');
    ...
    suite.test('mceInsertLink (link around existing complex contents with links)', function (editor) {
        editor.setContent('<p><span id="s1"><strong><a id="a" href="#1"><em>1</em></a></strong></span><span id="s2">' +
            '<em><a id="b" href="#2"><strong>2</strong></a></em></span></p>');
        editor.execCommand('SelectAll');
        editor.execCommand('mceInsertLink', false, 'link');
        LegacyUnit.equal(editor.getContent(), '<p><a href="link"><span id="s1"><strong><em>1</em>' +
    ...
    suite.test('RemoveFormat', function (editor) {
        ...
        editor.setContent('<p><dfn>dfn tag </dfn> <code>code tag </code> <samp>samp tag</samp> ' +
...
//# sourceMappingURL=FormattingCommandsTest.js.map