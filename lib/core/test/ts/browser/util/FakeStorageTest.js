...
UnitTest.asynctest('browser.tinymce.core.util.LocalStorageTest', function (success, failure) {
    var suite = LegacyUnit.createSuite();
    var LocalStorage = FakeStorage.create();
...
//# sourceMappingURL=FakeStorageTest.js.map