...
UnitTest.asynctest('browser.tinymce.core.annotate.AnnotateTest', function (success, failure) {
    ModernTheme();
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        var tinyApis = TinyApis(editor);
        // TODO: Consider testing collapse sections.
        var sTestWordGrabIfCollapsed = Logger.t('Should word grab with a collapsed selection', GeneralSteps.sequence([
        ...
        var sTestCanAnnotateDirectParentOfRoot = Logger.t('Should be able to annotate a direct parent of the body (e.g. an empty paragraph)', GeneralSteps.sequence([
        ...
        var sTestCanAnnotateBeforeTwoNonBreakingSpaces = Logger.t('Should annotate when the cursor is collapsed before two nbsps', GeneralSteps.sequence([
            ...
            Assertions.sAssertStructure('Checking body element', ApproxStructure.build(function (s, str, arr) {
        ...
        var sTestCanAnnotateWithinTwoNonBreakingSpaces = Logger.t('Should annotate when the cursor is collapsed between two nbsps', GeneralSteps.sequence([
            tinyApis.sSetContent('<p>Annotation here &nbsp;&nbsp;, please</p>'),
            tinyApis.sSetCursor([0, 0], 'Annotation here  '.length),
            sAnnotate(editor, 'test-annotation', 'test-uid', { anything: 'nbsp-paragraph' }),
            Assertions.sAssertStructure('Checking body element', ApproxStructure.build(function (s, str, arr) {
        ...
        var sTestCanAnnotateAfterTwoNonBreakingSpaces = Logger.t('Should annotate when the cursor is collapsed after two nbsps', GeneralSteps.sequence([
            tinyApis.sSetContent('<p>Annotation here &nbsp;&nbsp;, please</p>'),
            tinyApis.sSetCursor([0, 0], 'Annotation here   '.length),
            sAnnotate(editor, 'test-annotation', 'test-uid', { anything: 'nbsp-paragraph' }),
            Assertions.sAssertStructure('Checking body element', ApproxStructure.build(function (s, str, arr) {
        ...
        var sTestDoesNotWordGrabIfNotCollapsed = Logger.t('Should not word grab if the selection is not collapsed', GeneralSteps.sequence([
            // '<p>This |is| the first paragraph</p><p>This is the second.</p>'
        ...
        var sTestInOneParagraph = Logger.t('Testing in one pararaph', GeneralSteps.sequence([
            // '<p>This |is| the first paragraph</p><p>This is the second.</p>'
            tinyApis.sSetContent('<p>This is the first paragraph</p><p>This is the second.</p>'),
        ...
        var sTestInTwoParagraphs = Logger.t('Testing over two paragraphs', GeneralSteps.sequence([
            // '<p>This |is the first paragraph</p><p>This is| the second.</p>'
            tinyApis.sSetContent('<p>This is the first paragraph</p><p>This is the second.</p>'),
        ...
        var sTestInThreeParagraphs = Logger.t('Testing over three paragraphs', GeneralSteps.sequence([
...
//# sourceMappingURL=AnnotateTest.js.map