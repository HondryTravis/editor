...
UnitTest.asynctest('browser.tinymce.core.EditorViewIframeTest', function () {
    ...
    var sTestIsXYInContentArea = function (editor) {
        return Step.sync(function () {
            ...
            Assertions.assertEq('Should be inside the area since the scrollbars are excluded', true, EditorView.isXYInContentArea(editor, rect.width - 25, rect.height - 25));
            Assertions.assertEq('Should be outside the area since the cordinate is on the scrollbars', false, EditorView.isXYInContentArea(editor, rect.width - 5, rect.height - 5));
        });
    };
...
//# sourceMappingURL=EditorViewIframeTest.js.map