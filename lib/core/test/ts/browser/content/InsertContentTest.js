...
UnitTest.asynctest('browser.tinymce.core.content.InsertContentTest', function (success, failure) {
    ...
    suite.test('insertAtCaret - ul with trailing empty block in middle of li', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<ul><li>a</li><li>b</li><li>c</li><li>d</li></ul>');
        assertSelection(editor, 'li:nth-child(3)', 1);
    });
...
//# sourceMappingURL=InsertContentTest.js.map