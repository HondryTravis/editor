...
UnitTest.test('browser.tinymce.core.file.BlobCacheTest', function () {
    var uriToBlob = function (base64, type) {
        ...
        var arr = Uint8Array(str.length);
        for (i = 0; i < arr.length; i++) {
            arr[i] = str.charCodeAt(i);
        }
        return Blob([arr], { type: type });
    };
    var id = 'blob0';
    ...
    Assertions.assertEq('Testing original version of create() method', [id, base64, filename], [blobInfo.id(), blobInfo.base64(), blobInfo.filename()]);
    ...
    Assertions.assertEq('Testing if create() method accepts object', [id, base64, filename, uri], [blobInfo.id(), blobInfo.base64(), blobInfo.filename(), blobInfo.uri()]);
});
//# sourceMappingURL=BlobCacheTest.js.map