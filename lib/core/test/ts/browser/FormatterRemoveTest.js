...
UnitTest.asynctest('browser.tinymce.core.FormatterRemoveTest', function () {
    ...
    suite.test('Inline element style where element is format root', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="color: #ff0000; font-weight: bold;">' +
    ...
    suite.test('Partially selected inline element text with children', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p><b><em><span>12</span></em></b><em><span>34</span></em></p>', 'Partially selected inline element text with children');
    });
    suite.test('Partially selected inline element text with complex children', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="font-weight: bold;"><em><span style="color: #ff0000; font-weight: bold;">12</span>' +
    ...
    suite.test('Inline elements with exact flag', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p><span style="font-size: 10px;">1234</span><span style="color: #00ff00; font-size: 10px;">1234</span></p>', 'Inline elements with exact flag');
    });
    suite.test('Inline elements with variables', function (editor) {
        ...
        LegacyUnit.equal(getContent(editor), '<p><span style="font-size: 10px;">1234</span><span style="color: #00ff00; font-size: 10px;">1234</span></p>', 'Inline elements on selected text with variables');
    });
    suite.test('Inline elements with functions and variables', function (editor) {
        ...
        LegacyUnit.equal(getContent(editor), '<p><span style="font-size: 10px;">1234</span><span style="color: #00ff00; font-size: 10px;">1234</span></p>', 'Inline elements with functions and variables');
    });
    ...
    suite.test('Remove span format within block with style', function (editor) {
        ...
        editor.selection.setRng(rng);
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p style="color: #ff0000;"><span style="color: #00ff00;">t</span>ex<span style="color: #00ff00;">t</span></p>', 'Remove span format within block with style');
    });
    ...
    suite.test('Remove ceFalseOverride format', function (editor) {
        ...
        editor.formatter.remove('format');
        LegacyUnit.equal(getContent(editor), '<p class="a" contenteditable="false">a</p><div contenteditable="false">b</div>');
...
//# sourceMappingURL=FormatterRemoveTest.js.map