...
UnitTest.asynctest('browser.tinymce.core.dom.ContentCssCorsTest', function (success, failure) {
    Theme();
    var cAssertCorsLinkPresence = function (expected) { return Chain.op(function (editor) {
        var corsLinks = editor.getDoc().querySelectorAll('link[crossorigin="anonymous"]');
...
//# sourceMappingURL=ContentCssCorsTest.js.map