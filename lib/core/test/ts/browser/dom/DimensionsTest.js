...
UnitTest.asynctest('browser.tinymce.core.dom.DimensionsTest', function (success, failure) {
    ...
    suite.test('getClientRects from array', function () {
        ...
        var clientRects = Dimensions.getClientRects(Arr.from(viewElm.childNodes));
