...
UnitTest.asynctest('browser.tinymce.core.dom.ScrollIntoViewTest', function () {
    ...
    var sScrollElementIntoView = function (editor, selector, alignToTop) {
        return Step.sync(function () {
            ScrollIntoView.scrollElementIntoView(editor, editor.dom.select(selector)[0], alignToTop);
        });
    };
    var sScrollRangeIntoView = function (editor, path, offset) {
        return Step.sync(function () {
            var x = Cursors.calculateOne(Element.fromDom(editor.getBody()), path);
    ...
    var sAssertApproxScrollPosition = function (editor, x, y) {
        return Step.sync(function () {
            var actualX = editor.dom.getViewPort(editor.getWin()).x;
            var actualY = editor.dom.getViewPort(editor.getWin()).y;
...
//# sourceMappingURL=ScrollIntoViewTest.js.map