...
UnitTest.asynctest('browser.tinymce.core.dom.SelectionEventsTest', function () {
    ...
    var assertSelectAllRange = function (editor, actualRng) {
        Assertions.assertDomEq('Should be expected startContainer', Element.fromDom(editor.getBody()), Element.fromDom(actualRng.startContainer));
...
//# sourceMappingURL=SelectionEventsTest.js.map