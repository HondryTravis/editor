...
UnitTest.asynctest('browser.tinymce.core.delete.CefDeleteActionTest', function (success, failure) {
    ...
    var actionName = function (action) {
        return action.fold(Fun.constant('remove'), Fun.constant('moveToElement'), Fun.constant('moveToPosition'));
    };
    var actionValue = function (action) {
        return action.fold(Element.fromDom, Element.fromDom, Fun.identity);
    };
    viewBlock.attach();
    Pipeline.async({}, [
...
//# sourceMappingURL=CefDeleteActionTest.js.map