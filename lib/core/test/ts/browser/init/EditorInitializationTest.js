...
UnitTest.asynctest('browser.tinymce.core.init.EditorInitializationTest', function () {
    ...
    var mAssertEditors = Step.stateful(function (editors, next, die) {
        ...
        Assertions.assertEq('Should only be two skin files the skin and the content for inline mode', ['skin.min.css', 'content.inline.min.css'], getSkinCssFilenames());
...
//# sourceMappingURL=EditorInitializationTest.js.map