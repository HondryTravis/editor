...
var link = (function () {
    ...
    var open$$1 = function (url) {
      if (!global$2.ie || global$2.ie > 10) {
        ...
        if (win) {
          ...
          doc.open();
          doc.write('<meta http-equiv="refresh" content="0; url=' + global$1.DOM.encode(url) + '">');
          doc.close();
        }
      }
    };
    ...
    var toggleTargetRules = function (rel, isUnsafe) {
      ...
      var toString = function (rel) {
        return global$3.trim(rel.sort().join(' '));
      };
    ...
    var showDialog = function (editor, linkList) {
      ...
      var buildAnchorListControl = function (url) {
        var anchorList = [];
        global$3.each(editor.dom.select('a:not([href])'), function (anchor) {
      ...
      var urlChange = function (e) {
        ...
        global$3.each(e.meta, function (value, key) {
      ...
      win = editor.windowManager.open({
        ...
        onSubmit: function (e) {
          ...
          var resultData = global$3.extend({}, data, e.data);
